...
(function (root, doc, factory) {
    ...
    (function ($, undefined) {
        ...
        $.mobile.changePage = function (toPage, options) {
            ...
            if (!historyDir) {
                // Overwrite the current entry if it's a rightover from a dialog
                if (alreadyThere) {
                ...
                .each(function () {
                    ...
                    if (role === "header" || role === "footer") {
                        ...
                        if (role === "header") {
                            ...
                            leftbtn = leftbtn || $headeranchors.eq(1).not(".ui-btn-right").addClass("ui-btn-left").length;
                            rightbtn = rightbtn || $headeranchors.eq(0).addClass("ui-btn-right").length;
                        }
    ...
    (function ($, undefined) {
        ...
        $.fn.controlgroup = function (options) {
            function flipClasses(els, flCorners) {
                els.removeClass("ui-btn-corner-all ui-corner-top ui-corner-bottom ui-corner-right ui-corner-left ui-controlgroup-last ui-shadow")
            ...
            return this.each(function () {
                var $el = $(this),
                    ...
                    flCorners = o.direction === "horizontal" ? ["ui-corner-right", "ui-corner-left"] : ["ui-corner-top", "ui-corner-bottom"],
